(function() {
        ...
        EncryptedForm.prototype = {
            ...
            addValidations: function() {
                var cse = this,
                    ...
                    c = elements.length,
                    element, handlers = {}, elementsByName = {};
                for (; c-- > 0;) {
                    element = elements[c];
    ...
    if (typeof adyen.encrypt.createEncryptedForm === "function") {
        (function() {
            var key = "10001|";
